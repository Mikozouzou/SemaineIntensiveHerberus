...
public class ButtonManager : MonoBehaviour {
    ...
    public void Update()
    {
        if (m_ReadyToPlay)
        {
            ...
            if (XInput.instance.getLeftYStick(1) < 0.3f && XInput.instance.getLeftYStick(1) > -0.3f)
            {
                m_EndInput = true;
            }
        ...
        {
            if (XInput.instance.getButton(1, 'A') == ButtonState.Pressed/*Input.GetButton("A_0") || Input.GetButton("B_0")*/)
            {
    ...
    public void CheckInputPositions()
    {
        ...
        if (XInput.instance.getLeftYStick(1) > 0.3f && m_EndInput)
            {
            SelectUpperButton();
        }
